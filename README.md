...
EXERCICIO 3 (PROBLEMA DESAFIO) - NOTA: 7,5/10,0;
DESÁFIO:
Problema: A Máquina de Café Inteligente
...
Após processar todos os comandos, imprima um relatório final contendo o total de cafés servidos, a água restante e os grãos restantes, no formato: Total de cafes: [quantidade] Agua: [ml] ml, Graos: [g] g
